(function initProjectStarfallDataSkills(global) {
  ...
  function createSkillData(options) {
    ...
    const SKILLS = Object.freeze([
      ...
      skill('storm_mage_chain_bolt', 'Chain Bolt', 'stormMage', 'Advanced Skill Batch', 'Primary training attack', ['Mobbing', 'Hybrid'], [], 'Low-cooldown lightning chain for Storm Mage training. Each jump loses power, rewarding deliberate target order while preserving strong clustered clear and lower single-target boss value.', { resourceCost: 6, cooldown: 0.78, lineCount: 3, lineDamageScale: 0.58, primaryTraining: true, targeting: projectileTargeting({ mode: 'chain', projectileType: 'lightning', range: 380, rangePerRank: 4, speed: 720, chainRange: 220, chainRangePerRank: 6, chainTargets: 3, chainTargetsPerRanks: 2, maxChainTargets: 8, chainDamageFalloff: 0.72, applySlow: true }) }),
