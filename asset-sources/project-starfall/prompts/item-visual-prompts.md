...
## Accessory Icon Prompt

```text
Clean professional 2D game icon of [accessory name], [ring/charm/offhand/focus/tool], Project Starfall Starlit Frontier Fantasy, large readable functional silhouette, [class or biome motif], crisp outline, upper-left lighting, transparent background, no frame, no text, readable at 64x64.
```
