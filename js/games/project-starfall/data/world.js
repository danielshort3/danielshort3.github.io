(function initProjectStarfallDataWorld(global) {
  ...
  const WORLD_MAP_EDGES = Object.freeze([
    ...
    Object.freeze({ id: 'thornpath_bandit', fromMapId: 'thornpathThicket', toMapId: 'banditRidgeCamp', type: 'field', routeId: 'forest', requiredMapId: 'thornpathThicket', requiredLevel: 12, portalIds: Object.freeze({ from: 'thornpath_bandit', to: 'bandit_thornpath' }) }),
    ...
    Object.freeze({ id: 'bandit_brambleking_court', fromMapId: 'banditRidgeCamp', toMapId: 'bramblekingCourt', type: 'dungeon', requiredLevel: 32, requiredQuestId: 'brambleking_echo', portalIds: Object.freeze({ from: 'bandit_brambleking_court', to: 'court_return' }) }),
    ...
    Object.freeze({ id: 'rustcoil_outpost_ruins', fromMapId: 'rustcoilOutpost', toMapId: 'rustcoilRuins', type: 'field', routeId: 'ruins', requiredLevel: 6, portalIds: Object.freeze({ from: 'rustcoil_outpost_ruins', to: 'rustcoil_outpost_return' }) }),
    ...
    Object.freeze({ id: 'quarry_titan_foundry', fromMapId: 'orebackQuarry', toMapId: 'titanFoundry', type: 'dungeon', requiredLevel: 50, requiredQuestId: 'titan_foundry_echo', portalIds: Object.freeze({ from: 'quarry_titan_foundry', to: 'foundry_return' }) }),
    Object.freeze({ id: 'quarry_deepcore_core', fromMapId: 'orebackQuarry', toMapId: 'deepcoreCore', type: 'dungeon', requiredLevel: 60, requiredQuestId: 'deepcore_echo', portalIds: Object.freeze({ from: 'quarry_deepcore_core', to: 'deepcore_return' }) }),
    ...
    Object.freeze({ id: 'cinder_emberjaw_furnace', fromMapId: 'cinderHollow', toMapId: 'emberjawFurnace', type: 'dungeon', requiredLevel: 42, requiredQuestId: 'emberjaw_echo', portalIds: Object.freeze({ from: 'cinder_emberjaw_furnace', to: 'furnace_return' }) }),
    ...
    Object.freeze({ id: 'frostfen_glacier', fromMapId: 'frostfenOutskirts', toMapId: 'glacierSpine', type: 'field', routeId: 'frostfen', requiredMapId: 'frostfenOutskirts', portalIds: Object.freeze({ from: 'frostfen_glacier', to: 'glacier_frostfen_outskirts' }) }),
    ...
    Object.freeze({ id: 'glacier_rimewarden_vault', fromMapId: 'glacierSpine', toMapId: 'rimewardenVault', type: 'dungeon', requiredLevel: 66, requiredQuestId: 'rimewarden_echo', portalIds: Object.freeze({ from: 'glacier_rimewarden_vault', to: 'vault_return' }) }),
    ...
    Object.freeze({ id: 'cliffs_stormbreak_aerie', fromMapId: 'stormbreakCliffs', toMapId: 'stormbreakAerie', type: 'dungeon', requiredLevel: 76, requiredQuestId: 'stormbreak_echo', portalIds: Object.freeze({ from: 'cliffs_stormbreak_aerie', to: 'aerie_return' }) }),
    ...
    Object.freeze({ id: 'archive_astral_stacks', fromMapId: 'astralArchive', toMapId: 'astralStacks', type: 'dungeon', requiredLevel: 88, requiredQuestId: 'astral_echo', portalIds: Object.freeze({ from: 'archive_astral_stacks', to: 'stacks_return' }) }),
    ...
    Object.freeze({ id: 'frontier_eclipse_throne', fromMapId: 'eclipseFrontier', toMapId: 'eclipseThrone', type: 'dungeon', requiredLevel: 100, requiredQuestId: 'eclipse_echo', portalIds: Object.freeze({ from: 'frontier_eclipse_throne', to: 'throne_return' }) }),
