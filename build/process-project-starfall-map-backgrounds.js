...
const SOURCE_BACKED_MAPS = Object.freeze([
  ['starfall-crossing.webp', 'starfall-crossing.png'],
...
async function validateMapBackground(outputName) {
  ...
  if (metadata.width !== TILE_WIDTH || metadata.height !== TILE_HEIGHT) {
    throw new Error(`${outputName} should be ${TILE_WIDTH}x${TILE_HEIGHT}, got ${metadata.width}x${metadata.height}`);
  }
