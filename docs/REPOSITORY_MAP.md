...
| --- | --- | --- |
| About copy, brand tagline, interests, experience, education, credentials | [personal audience content](../content/audiences/personal.json) | `page.sections[].props.welcome` supplies the closed-home introduction and links through [CMS widgets](../api/_lib/cms-widgets.js); [site-frame.js](../js/navigation/site-frame.js) reuses that authored welcome after mount. `renderHomeBackground` renders the resume-style timeline; [About CSS](../css/components/home-about.css), [background CSS](../css/components/home-background.css) |
