  ...
  function createMapCatalogData(options) {
    ...
    const MAPS = Object.freeze([
      ...
      makeExpandedTrainingMap({
        ...
        purpose: 'Four playful frontier outposts with an ordered sigil patrol before endless scaling.',
