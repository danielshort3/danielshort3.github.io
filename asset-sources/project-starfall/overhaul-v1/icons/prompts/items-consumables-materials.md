...
Create ONE production item icons atlas, exactly 5 equally wide columns by 4 equally high rows, regular rectangular grid covering the entire image, read left-to-right then top-to-bottom. This is one coherent atlas asset, not separate images. Each icon is centered in its assigned cell, entirely isolated, no overlap, all artwork within the central 72% of each cell, generous gutters. No visible grid lines. Genuine alpha transparency behind every object; do not paint a checkerboard or colored background. Clear silhouettes readable after export at 64px. Item materials are physical leather/cloth/metal/crystal, not flat UI pictograms. No large outer glow or background aura; rarity decoration is drawn separately by the game.
Row 1, column 1: coins.
Row 1, column 2: town return scroll.
Row 1, column 3: guard tonic.
Row 1, column 4: swiftstep oil.
Row 1, column 5: magnet charm.
Row 2, column 1: pet whistle.
Row 2, column 2: cube fragment.
Row 2, column 3: base skill manual.
Row 2, column 4: advanced skill manual.
Row 2, column 5: skill reset scroll.
Row 3, column 1: stat reset scroll.
Row 3, column 2: admin worldwright console.
Row 3, column 3: upgrade dust.
Row 3, column 4: upgrade catalyst.
Row 3, column 5: warding scroll.
Row 4, column 1: refinement core.
Row 4, column 2: gel drop.
Row 4, column 3: ore chunks.
Row 4, column 4: line catalyst.
Row 4, column 5: completely empty transparent cell.
