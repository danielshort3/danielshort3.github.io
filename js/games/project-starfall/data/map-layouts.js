(function initProjectStarfallDataMapLayouts(global) {
  ...
  const DUNGEON_ARENA_SKELETONS = Object.freeze({
    ...
    gearworksVault: Object.freeze({ id: 'staged-gearworks-route', mechanic: 'intake lane, Titan catwalk, master gear switch, and sealed assembly core', left: 260, right: 3130, lowW: 900, midW: 760, highW: 500, midInset: 150, highInset: 1220, rightMidInset: 230, rightHighInset: 0, lowShift: -8, midShift: -18, highShift: 0 }),
    ...
    rimewardenSanctum: Object.freeze({ id: 'ice-wall-vault', mechanic: 'brute lane, oracle shelf, and sentinel shelf', entryClearance: 440, left: 340, right: 2400, lowW: 960, midW: 820, highW: 700, midInset: 280, highInset: 600, rightMidInset: 300, rightHighInset: 80, lowShift: -4, midShift: 16, highShift: 12 }),
