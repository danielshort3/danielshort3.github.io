...
**Historical rejected candidate.** These controls use the pre-adjustment Cinder 1.00 profile. The roster candidate was not adopted; the final normal-kill 0.93 scalar has separate [observed confirmation](training-cinder-observed-adjustment.json).
