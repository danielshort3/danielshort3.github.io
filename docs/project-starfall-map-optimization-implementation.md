...
- Added bespoke `geometry-spawn-v1` layouts for the audit's highest-priority field maps:
  ...
  - Bandit Ridge Camp now has lower cutter, middle thrower, high rope-bridge, and campfire-regroup sections.
