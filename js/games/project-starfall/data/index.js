(function initProjectStarfallDataIndex(global) {
  ...
  const SPECIALIZATION_RESPEC_COST = DataSpecializations.SPECIALIZATION_RESPEC_COST;
  ...
  const WEEKLY_STAR_ROUTES_CONFIG = DataCommerce.WEEKLY_STAR_ROUTES_CONFIG;
  ...
  const DUNGEON_MASTERY_RANKS = progressionContentData.DUNGEON_MASTERY_RANKS;
