(() => {
  ...
  const buildResumePrompt = (context = {}) => {
    ...
    return [
      ...
      '3. Portfolio website: danielshort.me. This site lists my projects and highlights selected results (e.g., hours saved through automation, traffic lift, and an RL puzzle solver demo). For this resume, focus on three projects - Chatbot (LoRA + RAG), Shape Classifier Demo, and Sheet Music Restoration - and ignore the others. It also includes sections on certifications, degrees and demonstrated strengths (Python, SQL & ETL, Tableau dashboards, data wrangling, reinforcement learning, regression analysis).',
      '',
