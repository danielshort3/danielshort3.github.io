...
window.PROJECTS = [
  {
    published: false,
    id: "destinationPerformanceDashboard",
    title: "Destination Performance Dashboard",
    subtitle: "Tourism KPIs, Pacing, and Stakeholder Reporting",
    image: "img/projects/destinationPerformanceDashboard.svg",
    imageAlt: "Illustrated dashboard cover for tourism KPI reporting and destination performance analysis",
    imageWidth: 1200,
    imageHeight: 1200,
    tools: ["Python", "SQL", "Tableau", "Excel"],
    concepts: ["Analytics", "Automation", "Visualization"],
    resources: [
      { icon: "img/icons/pdf-icon.png", url: "documents/VGJ_2024_Accomplishments.pdf", label: "2024 Accomplishments" },
      { icon: "img/icons/pdf-icon.png", url: "documents/GJ_2025_Budget.pdf", label: "2025 City Budget" },
      { icon: "img/icons/website-icon.png", url: "https://ccbrief.my.canva.site/city-council-briefing-oct-20-2025", label: "Council Briefing" }
    ],
    role: [
      "Built the reporting system and analytics narrative used across recurring stakeholder updates."
    ],
    notes: "Draws on public Visit Grand Junction deliverables covering budget planning, annual accomplishments, and council-ready tourism reporting.",
    problem: "Visit Grand Junction needed a repeatable way to translate visitor demand, tax, lodging, and website signals into stakeholder-ready destination reporting.",
    actions: [
      "Consolidated tourism KPIs across pacing, tax, website, and visitation sources into repeatable reporting views.",
      "Built automated workflows and dashboard outputs for recurring stakeholder updates, budget planning, and leadership briefings.",
      "Packaged the same KPI foundation into public-facing accomplishment reports, city budget inputs, and council-ready summaries."
    ],
    results: [
      "Reduced recurring reporting turnaround time by 99% and saved 200+ hours per year.",
      "Gave leadership a consistent view of visitor demand, revenue signals, and destination marketing performance.",
      "Supported annual accomplishments, city budget planning, and ongoing council briefings with a reusable reporting layer."
    ],
    caseStudy: [
      {
        title: "Business Problem",
        lead: "Destination teams need one reporting layer that works for operators, executives, and public-sector stakeholders without rebuilding the story every week.",
        bullets: [
          "The inputs span lodging, tax, visitation, website, and campaign performance data.",
          "Leaders need both current pacing and longer-horizon planning signals.",
          "Outputs have to work in dashboards, PDFs, and live briefings."
        ]
      },
      {
        title: "Reporting System",
        bullets: [
          "Standardized recurring KPIs so monthly and weekly reporting stays comparable.",
          "Built automated refreshes and reusable views instead of manually rebuilding reports.",
          "Kept the output stakeholder-ready, with summaries that can be reused in board, council, and budget settings."
        ]
      },
      {
        title: "Metrics That Matter",
        bullets: [
          "Tracked visitor demand, lodging and tax signals, website performance, and destination marketing outcomes.",
          "Connected pacing-style monitoring with annual performance storytelling.",
          "Focused the reporting on decisions: where demand is moving, what changed, and what needs attention next."
        ]
      },
      {
        title: "Transferability",
        bullets: [
          "Visitor demand maps directly to customer demand planning in other industries.",
          "Destination pacing and revenue signals map cleanly to sales, occupancy, and pipeline reporting.",
          "The same reporting design works for tourism, events, retail, and other stakeholder-heavy environments."
        ]
      }
    ]
  },
  ...
  {
    published: false,
    id: "campaignPerformanceReporting",
    title: "Campaign Performance Reporting",
    subtitle: "Destination Marketing Analytics and ROI Reporting",
    image: "img/projects/campaignPerformanceReporting.svg",
    imageAlt: "Illustrated cover for tourism campaign reporting, stakeholder dashboards, and performance measurement",
    imageWidth: 1200,
    imageHeight: 1200,
    tools: ["Python", "SQL", "Tableau", "Excel"],
    concepts: ["Analytics", "Automation", "Visualization"],
    resources: [
      { icon: "img/icons/website-icon.png", url: "https://us4.campaign-archive.com/?u=d69163b71ce34ec42d130a6a4&id=55cca83f35", label: "Stakeholder eNewsletter" },
      { icon: "img/icons/website-icon.png", url: "https://ccbrief.my.canva.site/city-council-briefing-oct-20-2025", label: "Council Briefing" },
      { icon: "img/icons/pdf-icon.png", url: "documents/VGJ_2024_Accomplishments.pdf", label: "Annual Accomplishments" }
    ],
    role: [
      "Owned the reporting workflows that turned campaign, website, and tourism metrics into recurring stakeholder communication."
    ],
    notes: "Grounded in public stakeholder newsletters and council briefing materials produced for Visit Grand Junction.",
    problem: "Marketing and leadership teams needed campaign performance translated into concise reporting that connected activity to visitor insights and stakeholder decisions.",
    actions: [
      "Automated weekly and monthly reporting for industry data updates, stakeholder newsletters, and council briefings.",
      "Connected website, lodging, revenue, and campaign indicators so performance could be read in one narrative.",
      "Standardized stakeholder-ready summaries for recurring distribution instead of rebuilding decks and reports by hand."
    ],
    results: [
      "Cut recurring report preparation time by 99% while keeping stakeholders updated on campaign performance and visitor insights.",
      "Supported a 565% increase in page views and 122% growth in sessions by making performance visible and actionable.",
      "Created a repeatable reporting cadence for marketing, public-sector, and partner audiences."
    ],
    caseStudy: [
      {
        title: "Solved Business Problem",
        lead: "This work solved the reporting gap between marketing activity and stakeholder understanding by packaging campaign performance into repeatable business updates.",
        bullets: [
          "Leadership needed concise reporting, not raw dashboards alone.",
          "Partners needed to understand what changed and why it mattered.",
          "The reporting had to work across newsletters, briefings, and executive updates."
        ]
      },
      {
        title: "Method",
        bullets: [
          "Automated recurring KPI pulls and summary generation to remove manual reporting bottlenecks.",
          "Combined website analytics, destination signals, and campaign context into one reporting layer.",
          "Structured outputs around business questions such as demand, reach, engagement, and stakeholder impact."
        ]
      },
      {
        title: "Impact",
        bullets: [
          "Recurring reporting became fast enough to support an ongoing stakeholder cadence rather than sporadic updates.",
          "Campaign performance became easier to explain to non-technical audiences.",
          "The same framework now supports destination marketing, visitor insights, and economic-impact storytelling."
        ]
      },
      {
        title: "Why It Transfers",
        bullets: [
          "Campaign ROI in tourism uses the same logic as marketing attribution in other industries.",
          "Stakeholder reporting is transferable to public sector, retail, B2B, and event organizations.",
          "The core skill is turning noisy marketing data into decisions leadership can actually use."
        ]
      }
    ]
  },
  ...
  {
    published: false,
    id: "eventAttendanceForecasting",
    title: "Event Attendance & Demand Forecasting",
    subtitle: "Forecasting Demand Across Dates, Markets, and Channels",
    image: "img/projects/eventAttendanceForecasting.svg",
    imageAlt: "Illustrated cover for event attendance forecasting and demand planning",
    imageWidth: 1200,
    imageHeight: 1200,
    tools: ["Python", "SQL", "Excel"],
    concepts: ["Analytics", "Visualization"],
    role: [
      "Created this bridge case study to show how destination-demand logic transfers directly to sports and events planning."
    ],
    notes: "Bridge project: a transferable forecasting framework rather than a client engagement with public performance metrics.",
    problem: "Event operators and destination teams face the same planning problem: estimating demand early enough to adjust staffing, marketing, and revenue plans before the date arrives.",
    actions: [
      "Designed a forecasting workflow that combines historical attendance, pacing curves, calendar effects, and channel mix.",
      "Built scenario inputs for best-case, expected, and downside demand so plans can change before an event underperforms.",
      "Mapped event-attendance logic back to destination analytics through origin markets, booking windows, and revenue-per-visitor style metrics."
    ],
    results: [
      "Created a reusable demand-forecasting blueprint for events, tourism campaigns, and other planning-heavy environments.",
      "Shows how the same analytics approach transfers from visitor demand to ticketed attendance and revenue planning.",
      "Produces stakeholder-ready outputs such as forecast tables, scenario ranges, and decision checkpoints."
    ],
    caseStudy: [
      {
        title: "Forecasting Logic",
        lead: "The bridge is simple: event attendance forecasting and destination demand forecasting both rely on early signals, historical pacing, and scenario planning.",
        bullets: [
          "Use historical patterns to set a baseline.",
          "Monitor pacing against comparable dates or events.",
          "Adjust expectations based on campaign mix, market shifts, and calendar effects."
        ]
      },
      {
        title: "Operational Outputs",
        bullets: [
          "Forecast by date, market, and channel so teams know where demand is coming from.",
          "Translate forecasts into staffing, marketing, and revenue implications.",
          "Make uncertainty explicit with scenario ranges instead of a single-point estimate."
        ]
      },
      {
        title: "Tourism-to-Events Bridge",
        bullets: [
          "Visitor demand maps to event attendance.",
          "Origin markets map to audience segments and feeder markets.",
          "RevPAR-style revenue thinking maps to ticket, sponsorship, and per-attendee revenue planning."
        ]
      },
      {
        title: "Why This Matters",
        bullets: [
          "DMOs can see direct relevance to destination planning.",
          "Sports and event organizations can see the same planning discipline applied to their own demand cycle.",
          "The project keeps the specialization clear without narrowing future opportunities."
        ]
      }
    ]
  },
