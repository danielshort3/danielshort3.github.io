(function initProjectStarfallDataAssetBackupContent(global) {
  ...
  function createAssetBackupContentData(options) {
    ...
    return createAssetBackupData({
      ...
      CLASS_ASSETS: settings.CLASS_ASSETS || assetData.CLASS_ASSETS,
      PLAYER_ANIMATION_ASSETS: settings.PLAYER_ANIMATION_ASSETS || actorCombatData.PLAYER_ANIMATION_ASSETS,
