...
module.exports = function runSlotMachineDemoTests({ assert, checkFileContains }) {
  ...
  assert(fs.existsSync(configPath), 'config/classic.json missing');
  ...
  checkFileContains('demos/slot-machine-demo.html', 'data-machine-config="config/classic.json"');
  ...
  checkFileContains('demos/slot-machine-demo.html', 'config/upgrade-definitions.json');
  ...
  assert(fs.existsSync('assets/placeholder.png'), 'slot placeholder asset missing');
  ...
  assert(fs.existsSync(machineIndexPath), 'config/machines/index.json missing');
  ...
  assert(fs.existsSync('assets/gear/basic/gear_basic_accessory.png'), 'basic gear icon missing');
  ...
  assert(fs.existsSync('assets/cards/basic/vip_lucky_penny.png'), 'card icon missing');
