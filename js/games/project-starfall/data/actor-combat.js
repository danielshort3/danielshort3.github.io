(function initProjectStarfallDataActorCombat(global) {
  ...
  function createActorCombatData(options) {
    ...
    const CLASS_FAMILY_IDS = settings.CLASS_FAMILY_IDS || DataAssets.CLASS_FAMILY_IDS;
    const CLASS_BODY_FAMILIES = settings.CLASS_BODY_FAMILIES || DataAssets.CLASS_BODY_FAMILIES;
    const CLASS_FAMILY_FILE_IDS = settings.CLASS_FAMILY_FILE_IDS || DataAssets.CLASS_FAMILY_FILE_IDS;
    const PLAYER_ART_VERSION = settings.PLAYER_ART_VERSION || DataAssets.PLAYER_ART_VERSION;
    ...
    const combatFxData = DataCombatFx.createCombatFxData({
      ...
      ENEMY_COMBAT_FX_FILE_IDS: animationData.ENEMY_COMBAT_FX_FILE_IDS,
    ...
    return Object.freeze({
      ...
      PLAYER_FAMILY_ANIMATION_ASSETS: animationData.PLAYER_FAMILY_ANIMATION_ASSETS,
