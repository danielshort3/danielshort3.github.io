  ...
  function loadStyles() {
    if (!document.getElementById(CRITICAL_STYLE_ID)) {
      ...
      critical.textContent = [
        ...
        '#pcz-modal .pcz-panel{--pcz-panel-radius:var(--modal-radius,12px);position:relative;background:var(--modal-surface,#fff);color:#091f3b;border:4px solid var(--modal-border,#091f3b);box-shadow:var(--modal-shadow,0 24px 56px rgba(9,31,59,.16));border-radius:var(--pcz-panel-radius);}',
