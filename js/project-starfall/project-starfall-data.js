(function initProjectStarfallData(global) {
  ...
  const MAP_ENVIRONMENT_PROFILES = Object.freeze({
    starfallCrossing: environmentProfile({ terrain: 'starfall-crossing', props: 'starfall-crossing', density: 0.48, propKinds: ['grass', 'bush', 'flower', 'small', 'crate', 'sign'] }),
    rustcoilOutpost: environmentProfile({ terrain: 'rustcoil-outpost', props: 'rustcoil-outpost', density: 0.46, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'sign'] }),
    cinderRefuge: environmentProfile({ terrain: 'cinder-refuge', props: 'cinder-refuge', density: 0.42, propKinds: ['rock', 'small', 'tall', 'crystal', 'glow', 'crate'] }),
    frostfenCamp: environmentProfile({ terrain: 'frostfen-camp', props: 'frostfen-camp', density: 0.46, propKinds: ['grass', 'rock', 'crystal', 'small', 'tall', 'sign'] }),
    stormbreakHaven: environmentProfile({ terrain: 'stormbreak-haven', props: 'stormbreak-haven', density: 0.44, propKinds: ['grass', 'bush', 'rock', 'crystal', 'small', 'sign'] }),
    astralObservatory: environmentProfile({ terrain: 'astral-observatory', props: 'astral-observatory', density: 0.42, propKinds: ['crystal', 'tall', 'sign', 'glow', 'rock', 'small'] }),
    greenrootMeadow: environmentProfile({ terrain: 'greenroot-meadow', props: 'greenroot-meadow', density: 0.62, propKinds: ['grass', 'bush', 'tree', 'flower', 'rock', 'vine'] }),
    thornpathThicket: environmentProfile({ terrain: 'thornpath-thicket', props: 'thornpath-thicket', density: 0.64, propKinds: ['grass', 'bush', 'tree', 'flower', 'vine', 'rock'] }),
    brambleDepths: environmentProfile({ terrain: 'bramble-depths', props: 'bramble-depths', density: 0.58, propKinds: ['bush', 'tree', 'vine', 'flower', 'rock', 'crystal'] }),
    rustcoilRuins: environmentProfile({ terrain: 'rustcoil-ruins', props: 'rustcoil-ruins', density: 0.52, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'sign'] }),
    gearworksVault: environmentProfile({ terrain: 'gearworks-vault', props: 'gearworks-vault', density: 0.5, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'glow'] }),
    cinderHollow: environmentProfile({ terrain: 'cinder-hollow', props: 'cinder-hollow', density: 0.48, propKinds: ['rock', 'small', 'tall', 'crystal', 'glow'] }),
    emberjawLair: environmentProfile({ terrain: 'emberjaw-lair', props: 'emberjaw-lair', density: 0.46, propKinds: ['rock', 'small', 'tall', 'crystal', 'glow'] }),
    banditRidgeCamp: environmentProfile({ terrain: 'bandit-ridge-camp', props: 'bandit-ridge-camp', density: 0.56, propKinds: ['grass', 'bush', 'tree', 'crate', 'sign', 'small'] }),
    banditAnimationLab: environmentProfile({ terrain: 'bandit-ridge-camp', props: 'bandit-ridge-camp', density: 0.2, propKinds: ['crate', 'sign', 'small'] }),
    orebackQuarry: environmentProfile({ terrain: 'oreback-quarry', props: 'oreback-quarry', density: 0.54, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'glow'] }),
    ashglassPass: environmentProfile({ terrain: 'ashglass-pass', props: 'ashglass-pass', density: 0.48, propKinds: ['rock', 'small', 'tall', 'crystal', 'glow'] }),
    frostfenOutskirts: environmentProfile({ terrain: 'frostfen-outskirts', props: 'frostfen-outskirts', density: 0.54, propKinds: ['grass', 'rock', 'crystal', 'small', 'tall', 'glow'] }),
    glacierSpine: environmentProfile({ terrain: 'glacier-spine', props: 'glacier-spine', density: 0.5, propKinds: ['rock', 'crystal', 'tall', 'small', 'glow'] }),
    rimewardenSanctum: environmentProfile({ terrain: 'rimewarden-sanctum', props: 'rimewarden-sanctum', density: 0.44, propKinds: ['crystal', 'tall', 'rock', 'glow', 'small'] }),
    stormbreakCliffs: environmentProfile({ terrain: 'stormbreak-cliffs', props: 'stormbreak-cliffs', density: 0.52, propKinds: ['grass', 'bush', 'rock', 'crystal', 'flower', 'tall'] }),
    astralArchive: environmentProfile({ terrain: 'astral-archive', props: 'astral-archive', density: 0.48, propKinds: ['crystal', 'tall', 'sign', 'glow', 'rock'] }),
    eclipseFrontier: environmentProfile({ terrain: 'eclipse-frontier', props: 'eclipse-frontier', density: 0.46, propKinds: ['grass', 'crystal', 'tall', 'glow', 'rock'] }),
    endlessRift: environmentProfile({ terrain: 'endless-rift', props: 'endless-rift', density: 0.48, propKinds: ['crystal', 'tall', 'glow', 'rock', 'flower'] }),
    bramblekingCourt: environmentProfile({ terrain: 'brambleking-court', props: 'brambleking-court', density: 0.54, propKinds: ['bush', 'tree', 'vine', 'flower', 'rock', 'crystal'] }),
    titanFoundry: environmentProfile({ terrain: 'titan-foundry', props: 'titan-foundry', density: 0.4, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'glow'] }),
    deepcoreCore: environmentProfile({ terrain: 'deepcore-core', props: 'deepcore-core', density: 0.42, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'glow'] }),
    emberjawFurnace: environmentProfile({ terrain: 'emberjaw-furnace', props: 'emberjaw-furnace', density: 0.44, propKinds: ['rock', 'small', 'tall', 'crystal', 'glow'] }),
    rimewardenVault: environmentProfile({ terrain: 'rimewarden-vault', props: 'rimewarden-vault', density: 0.44, propKinds: ['crystal', 'tall', 'rock', 'glow', 'small'] }),
    stormbreakAerie: environmentProfile({ terrain: 'stormbreak-aerie', props: 'stormbreak-aerie', density: 0.48, propKinds: ['rock', 'crystal', 'tall', 'small', 'glow'] }),
    astralStacks: environmentProfile({ terrain: 'astral-stacks', props: 'astral-stacks', density: 0.4, propKinds: ['crystal', 'tall', 'sign', 'glow', 'rock'] }),
    eclipseThrone: environmentProfile({ terrain: 'eclipse-throne', props: 'eclipse-throne', density: 0.36, propKinds: ['crystal', 'tall', 'glow', 'rock', 'sign'] }),
    guardian_trial: environmentProfile({ terrain: 'guardian-trial', props: 'guardian-trial', density: 0.42, propKinds: ['rock', 'small', 'tall', 'crate', 'sign', 'glow'] }),
    berserker_trial: environmentProfile({ terrain: 'berserker-trial', props: 'berserker-trial', density: 0.44, propKinds: ['rock', 'small', 'tall', 'crate', 'crystal', 'glow'] }),
    duelist_trial: environmentProfile({ terrain: 'duelist-trial', props: 'duelist-trial', density: 0.46, propKinds: ['grass', 'bush', 'crate', 'sign', 'small', 'rock'] }),
    fire_mage_trial: environmentProfile({ terrain: 'fire-mage-trial', props: 'fire-mage-trial', density: 0.38, propKinds: ['rock', 'small', 'tall', 'crystal', 'glow'] }),
    rune_mage_trial: environmentProfile({ terrain: 'rune-mage-trial', props: 'rune-mage-trial', density: 0.4, propKinds: ['crystal', 'tall', 'sign', 'glow', 'rock'] }),
    storm_mage_trial: environmentProfile({ terrain: 'storm-mage-trial', props: 'storm-mage-trial', density: 0.4, propKinds: ['rock', 'crystal', 'tall', 'small', 'glow'] }),
    sniper_trial: environmentProfile({ terrain: 'sniper-trial', props: 'sniper-trial', density: 0.42, propKinds: ['grass', 'bush', 'rock', 'crate', 'sign', 'small'] }),
    trapper_trial: environmentProfile({ terrain: 'trapper-trial', props: 'trapper-trial', density: 0.48, propKinds: ['grass', 'bush', 'tree', 'vine', 'rock', 'small'] }),
    beast_archer_trial: environmentProfile({ terrain: 'beast-archer-trial', props: 'beast-archer-trial', density: 0.46, propKinds: ['grass', 'bush', 'tree', 'rock', 'vine', 'sign'] })
  });

  const ITEM_ASSETS = Object.freeze({
    coins: `${ASSET_ROOT}/items/coins.png`,
    minor_health_potion: `${ASSET_ROOT}/items/minor-health-potion.png`,
    minor_resource_tonic: `${ASSET_ROOT}/items/minor-resource-tonic.png`,
    town_return_scroll: `${ASSET_ROOT}/items/town-return-scroll.png`,
    camp_ration: `${ASSET_ROOT}/items/camp-ration.png`,
    guard_tonic: `${ASSET_ROOT}/items/guard-tonic.png`,
    swiftstep_oil: `${ASSET_ROOT}/items/swiftstep-oil.png`,
    magnet_charm: `${ASSET_ROOT}/items/magnet-charm.png`,
    pet_whistle: `${ASSET_ROOT}/items/pet-whistle.png`,
    equipment_slot_coupon: `${ASSET_ROOT}/items/equipment-slot-coupon.png`,
    usable_slot_coupon: `${ASSET_ROOT}/items/usable-slot-coupon.png`,
    etc_slot_coupon: `${ASSET_ROOT}/items/etc-slot-coupon.png`,
    potential_cube: `${ASSET_ROOT}/items/attunement-prism.png`,
    preservation_cube: `${ASSET_ROOT}/items/echo-prism.png`,
    cube_fragment: `${ASSET_ROOT}/items/prism-shard.png`,
    base_skill_manual: `${ASSET_ROOT}/items/base-skill-manual.png`,
    advanced_skill_manual: `${ASSET_ROOT}/items/advanced-skill-manual.png`,
    skill_reset_scroll: `${ASSET_ROOT}/items/skill-reset-scroll.png`,
    stat_reset_scroll: `${ASSET_ROOT}/items/skill-reset-scroll.png`,
    admin_worldwright_console: `${ASSET_ROOT}/items/starbound-codex.png`,
    upgrade_dust: `${ASSET_ROOT}/items/upgrade-dust.png`,
    upgrade_catalyst: `${ASSET_ROOT}/items/upgrade-catalyst.png`,
    warding_scroll: `${ASSET_ROOT}/items/warding-scroll.png`,
    refinement_core: `${ASSET_ROOT}/items/refinement-core.png`,
    gel_drop: `${ASSET_ROOT}/items/gel-drop.png`,
    ore_chunks: `${ASSET_ROOT}/items/ore-chunks.png`,
    training_sword: `${ASSET_ROOT}/items/training-sword.png`,
    training_wand: `${ASSET_ROOT}/items/training-wand.png`,
    training_bow: `${ASSET_ROOT}/items/training-bow.png`,
    copper_sword: `${ASSET_ROOT}/items/copper-sword.png`,
    birch_wand: `${ASSET_ROOT}/items/birch-wand.png`,
    simple_bow: `${ASSET_ROOT}/items/simple-bow.png`,
    stitched_vest: `${ASSET_ROOT}/items/stitched-vest.png`,
    traveler_boots: `${ASSET_ROOT}/items/traveler-boots.png`,
    plain_ring: `${ASSET_ROOT}/items/plain-ring.png`,
    iron_sword: `${ASSET_ROOT}/items/iron-sword.png`,
    iron_axe: `${ASSET_ROOT}/items/iron-axe.png`,
    apprentice_staff: `${ASSET_ROOT}/items/apprentice-staff.png`,
    oak_longbow: `${ASSET_ROOT}/items/oak-longbow.png`,
    thorncrown_greatsword: `${ASSET_ROOT}/items/thorncrown-greatsword.png`,
    thornroot_staff: `${ASSET_ROOT}/items/thornroot-staff.png`,
    briarstring_longbow: `${ASSET_ROOT}/items/briarstring-longbow.png`,
    briar_crown: `${ASSET_ROOT}/items/briar-crown.png`,
    barkplate_harness: `${ASSET_ROOT}/items/barkplate-harness.png`,
    grasping_thorn_gloves: `${ASSET_ROOT}/items/grasping-thorn-gloves.png`,
    rootstep_greaves: `${ASSET_ROOT}/items/rootstep-greaves.png`,
    emberjaw_cleaver: `${ASSET_ROOT}/items/emberjaw-cleaver.png`,
    magma_scepter: `${ASSET_ROOT}/items/magma-scepter.png`,
    cindercoil_bow: `${ASSET_ROOT}/items/cindercoil-bow.png`,
    ashen_jaw_helm: `${ASSET_ROOT}/items/ashen-jaw-helm.png`,
    furnaceplate: `${ASSET_ROOT}/items/furnaceplate.png`,
    lavaforged_gauntlets: `${ASSET_ROOT}/items/lavaforged-gauntlets.png`,
    scorchtrail_boots: `${ASSET_ROOT}/items/scorchtrail-boots.png`,
    gearcleaver: `${ASSET_ROOT}/items/gearcleaver.png`,
    chrono_staff: `${ASSET_ROOT}/items/chrono-staff.png`,
    ratchet_repeater: `${ASSET_ROOT}/items/ratchet-repeater.png`,
    titan_visor: `${ASSET_ROOT}/items/titan-visor.png`,
    clockplate_harness: `${ASSET_ROOT}/items/clockplate-harness.png`,
    gyro_gauntlets: `${ASSET_ROOT}/items/gyro-gauntlets.png`,
    springstep_boots: `${ASSET_ROOT}/items/springstep-boots.png`,
    colossus_maul: `${ASSET_ROOT}/items/colossus-maul.png`,
    geode_scepter: `${ASSET_ROOT}/items/geode-scepter.png`,
    oreline_greatbow: `${ASSET_ROOT}/items/oreline-greatbow.png`,
    deepcore_helm: `${ASSET_ROOT}/items/deepcore-helm.png`,
    bedrock_plate: `${ASSET_ROOT}/items/bedrock-plate.png`,
    quarry_fists: `${ASSET_ROOT}/items/quarry-fists.png`,
    stonewake_boots: `${ASSET_ROOT}/items/stonewake-boots.png`,
    stormtalon_saber: `${ASSET_ROOT}/items/stormtalon-saber.png`,
    cloudspine_rod: `${ASSET_ROOT}/items/cloudspine-rod.png`,
    skybreaker_bow: `${ASSET_ROOT}/items/skybreaker-bow.png`,
    rocfeather_mask: `${ASSET_ROOT}/items/rocfeather-mask.png`,
    tempest_mantle: `${ASSET_ROOT}/items/tempest-mantle.png`,
    lightning_grip_gloves: `${ASSET_ROOT}/items/lightning-grip-gloves.png`,
    gale_boots: `${ASSET_ROOT}/items/gale-boots.png`,
    index_blade: `${ASSET_ROOT}/items/index-blade.png`,
    starbound_codex: `${ASSET_ROOT}/items/starbound-codex.png`,
    cometstring_bow: `${ASSET_ROOT}/items/cometstring-bow.png`,
    archivist_crown: `${ASSET_ROOT}/items/archivist-crown.png`,
    astral_robes: `${ASSET_ROOT}/items/astral-robes.png`,
    scribe_gloves: `${ASSET_ROOT}/items/scribe-gloves.png`,
    orbit_boots: `${ASSET_ROOT}/items/orbit-boots.png`,
    eclipse_edge: `${ASSET_ROOT}/items/eclipse-edge.png`,
    umbral_starstaff: `${ASSET_ROOT}/items/umbral-starstaff.png`,
    corona_longbow: `${ASSET_ROOT}/items/corona-longbow.png`,
    sovereign_crown: `${ASSET_ROOT}/items/sovereign-crown.png`,
    eclipse_plate: `${ASSET_ROOT}/items/eclipse-plate.png`,
    penumbra_gloves: `${ASSET_ROOT}/items/penumbra-gloves.png`,
    sunfall_boots: `${ASSET_ROOT}/items/sunfall-boots.png`,
    guardian_tower_shield: `${ASSET_ROOT}/items/guardian-tower-shield.png`,
    berserker_war_grip: `${ASSET_ROOT}/items/berserker-war-grip.png`,
    ember_core: `${ASSET_ROOT}/items/ember-core.png`,
    rune_etched_focus: `${ASSET_ROOT}/items/rune-etched-focus.png`,
    deadeye_scope: `${ASSET_ROOT}/items/deadeye-scope.png`,
    trap_kit: `${ASSET_ROOT}/items/trap-kit.png`
  });
  ...
  const FIGHTER_RIG_EQUIPMENT_VISUALS = Object.freeze({
  ...
  const SKILLS = Object.freeze([
    ...
    skill('guardian_shield_bash', 'Shield Bash', 'guardian', 'Advanced Skill Batch', 'Primary training attack', ['Hybrid', 'Control'], [], 'Low-cooldown guarded strike for Guardian training. Staggers enemies and builds Stored Impact for larger counters.', { resourceCost: 4, cooldown: 0.48, lineCount: 1, primaryTraining: true }),
    ...
    skill('berserker_blood_cleave', 'Blood Cleave', 'berserker', 'Advanced Skill Batch', 'Primary training attack', ['Mobbing', 'Hybrid'], [], 'Low-cooldown wide cleave for Berserker training. Damage rises as HP drops.', { resourceCost: 5, cooldown: 0.56, lineCount: 2, lineDamageScale: 0.82, primaryTraining: true }),
    ...
    skill('duelist_quick_cut', 'Quick Cut', 'duelist', 'Advanced Skill Batch', 'Primary training attack', ['Hybrid', 'Bossing'], [], 'Low-cooldown precise cut for Duelist training. Repeated hits on one target build Tempo.', { resourceCost: 4, cooldown: 0.42, lineCount: 3, lineDamageScale: 0.72, primaryTraining: true }),
    ...
    skill('rune_mage_ground_glyph', 'Ground Glyph', 'runeMage', 'Advanced Skill Batch', 'Area setup', ['Mobbing', 'Control'], [{ skillId: 'rune_mage_rune_mark', rank: 3, any: true }, { skillId: 'mage_arcane_burst', rank: 5, any: true }], 'Place a rune on the ground that damages or slows enemies.', { resourceCost: 24, cooldown: 7, lineCount: 2 }),
    ...
    skill('rune_mage_grand_inscription', 'Grand Inscription', 'runeMage', 'Advanced Skill Batch', 'Finisher', ['Mobbing', 'Support'], [{ skillId: 'rune_mage_rune_detonation', rank: 5 }, { skillId: 'mage_energy_release', rank: 10 }], 'Place a large rune field that empowers all rune effects inside it.', { resourceCost: 70, cooldown: 18, lineCount: 3 }),
    ...
    skill('storm_mage_chain_bolt', 'Chain Bolt', 'stormMage', 'Advanced Skill Batch', 'Primary training attack', ['Mobbing', 'Hybrid'], [], 'Low-cooldown lightning chain for Storm Mage training. Efficiently clears clustered enemies but has lower single-target boss value.', { resourceCost: 6, cooldown: 0.82, lineCount: 3, lineDamageScale: 0.58, primaryTraining: true, targeting: projectileTargeting({ mode: 'chain', projectileType: 'lightning', range: 360, rangePerRank: 3, speed: 720, chainRange: 190, chainRangePerRank: 5, chainTargets: 3, chainTargetsPerRanks: 2, maxChainTargets: 7, chainDamageFalloff: 0.9, applySlow: true }) }),
    ...
    skill('trapper_snare_trap', 'Snare Trap', 'trapper', 'Advanced Skill Batch', 'Primary training attack', ['Mobbing', 'Control'], [], 'Low-cooldown trap for Trapper training. Arms quickly, slows enemies, and sets up manual detonations.', { resourceCost: 4, cooldown: 0.55, lineCount: 1, lineDamageScale: 0.7, primaryTraining: true }),
  ...
  const FIELD_LAYOUT_STYLES = Object.freeze({
    ...
    rustcoilRuins: 'switchbackTerraces',
    cinderHollow: 'switchbackTerraces',
    banditRidgeCamp: 'sharedLanes',
    banditAnimationLab: 'sharedLanes',
    orebackQuarry: 'sharedLanes',
    ashglassPass: 'switchbackTerraces',
    frostfenOutskirts: 'sharedLanes',
    glacierSpine: 'verticalCanopy',
    stormbreakCliffs: 'sharedLanes',
    astralArchive: 'sharedLanes',
    eclipseFrontier: 'switchbackTerraces',
    endlessRift: 'sharedLanes'
  });
  ...
  function getFieldZoneAnchors(width) {
    const worldWidth = Math.max(6200, Math.ceil(Number(width || 0) / 100) * 100);
    const first = 260;
    const last = Math.max(first, worldWidth - 2020);
    return Array.from({ length: 4 }, (_, index) => Math.round(first + (last - first) * index / 3));
  }

  function makeFieldPlatforms(width, layoutStyle) {
    const worldWidth = Math.max(6200, Math.ceil(Number(width || 0) / 100) * 100);
    const anchors = getFieldZoneAnchors(worldWidth);
    const platforms = [[0, 520, worldWidth, 80]];
    const addPlatform = (x, y, w) => {
    ...
    anchors.forEach((anchor, index) => {
      if (layoutStyle === 'switchbackTerraces') {
        ...
        addPlatform(anchor + drift, TRAINING_LANE_Y.low, 1320);
        addPlatform(anchor + 1340 - drift * 0.25, TRAINING_LANE_Y.lowConnector, 240);
        addPlatform(anchor + 450 - drift * 0.6, TRAINING_LANE_Y.mid, 1220);
        addPlatform(anchor + 180 + drift * 0.55, TRAINING_LANE_Y.highConnector, 240);
        addPlatform(anchor + 40 + drift, TRAINING_LANE_Y.high, 1120);
        return;
      }
      if (layoutStyle === 'verticalCanopy') {
        const drift = index % 2 ? 170 : 0;
        addPlatform(anchor + drift, TRAINING_LANE_Y.low, 1040);
        addPlatform(anchor + 1180 - drift * 0.35, TRAINING_LANE_Y.lowConnector, 220);
        addPlatform(anchor + 360 - drift * 0.25, TRAINING_LANE_Y.mid, 980);
        addPlatform(anchor + 1040 + drift * 0.1, TRAINING_LANE_Y.highConnector, 220);
        addPlatform(anchor + 120 + drift * 0.55, TRAINING_LANE_Y.high, 940);
        return;
      }
      const laneOffset = index % 2 ? 90 : 0;
      addPlatform(anchor + laneOffset, TRAINING_LANE_Y.low, 1560);
      addPlatform(anchor + 1510, TRAINING_LANE_Y.lowConnector, 220);
      addPlatform(anchor + 260 - laneOffset * 0.4, TRAINING_LANE_Y.mid, 1420);
      addPlatform(anchor + 390, TRAINING_LANE_Y.highConnector, 220);
      addPlatform(anchor + 560 + laneOffset * 0.35, TRAINING_LANE_Y.high, 1280);
    });
    return platforms;
  }

  function makeFieldClimbables(prefix, width, layoutStyle) {
    const anchors = getFieldZoneAnchors(width);
    const climbables = [];
    anchors.forEach((anchor, index) => {
      if (layoutStyle === 'switchbackTerraces') {
        const drift = index % 2 ? 140 : 0;
        climbables.push({ id: `${prefix}_terrace_ladder_${index + 1}_low`, x: anchor + 240 + drift, y: TRAINING_LANE_Y.low, w: 30, h: TRAINING_LANE_Y.ground - TRAINING_LANE_Y.low });
        climbables.push({ id: `${prefix}_terrace_ladder_${index + 1}_mid`, x: anchor + 760 - drift * 0.45, y: TRAINING_LANE_Y.mid, w: 30, h: TRAINING_LANE_Y.low - TRAINING_LANE_Y.mid });
        climbables.push({ id: `${prefix}_terrace_ladder_${index + 1}_high`, x: anchor + 560 + drift * 0.35, y: TRAINING_LANE_Y.high, w: 30, h: TRAINING_LANE_Y.mid - TRAINING_LANE_Y.high });
        return;
      }
      if (layoutStyle === 'verticalCanopy') {
        const drift = index % 2 ? 170 : 0;
        climbables.push({ id: `${prefix}_canopy_vine_${index + 1}_low`, x: anchor + 180 + drift, y: TRAINING_LANE_Y.low, w: 28, h: TRAINING_LANE_Y.ground - TRAINING_LANE_Y.low });
        climbables.push({ id: `${prefix}_canopy_vine_${index + 1}_mid`, x: anchor + 720 - drift * 0.2, y: TRAINING_LANE_Y.mid, w: 28, h: TRAINING_LANE_Y.low - TRAINING_LANE_Y.mid });
        climbables.push({ id: `${prefix}_canopy_vine_${index + 1}_high`, x: anchor + 640 + drift * 0.15, y: TRAINING_LANE_Y.high, w: 28, h: TRAINING_LANE_Y.mid - TRAINING_LANE_Y.high });
        return;
      }
      const laneOffset = index % 2 ? 90 : 0;
      climbables.push({ id: `${prefix}_lane_rope_${index + 1}_low`, x: anchor + 180 + laneOffset, y: TRAINING_LANE_Y.low, w: 28, h: TRAINING_LANE_Y.ground - TRAINING_LANE_Y.low });
      climbables.push({ id: `${prefix}_lane_rope_${index + 1}_mid`, x: anchor + 1060, y: TRAINING_LANE_Y.mid, w: 28, h: TRAINING_LANE_Y.low - TRAINING_LANE_Y.mid });
      climbables.push({ id: `${prefix}_lane_rope_${index + 1}_high`, x: anchor + 820 + laneOffset * 0.2, y: TRAINING_LANE_Y.high, w: 28, h: TRAINING_LANE_Y.mid - TRAINING_LANE_Y.high });
    });
    return climbables;
  }
  ...
  function applyPartyPlayGeometry(map) {
    if (!map) return map;
    if (map.safeZone) {
      const width = Math.max(getAuthoredMapWidth(map), 3000);
      return Object.assign({}, map, {
        layoutStyle: 'townMainStreet',
        layoutRole: 'town',
        platforms: [[0, TRAINING_LANE_Y.ground, width, 80]],
        climbables: [],
        spawnPoints: []
      });
    }
    const width = Math.max(getAuthoredMapWidth(map), map.isDungeon ? 4600 : 8400);
    ...
    return Object.assign({}, map, {
      ...
      platforms,
      climbables: map.isDungeon ? makePartyPlayClimbables(map.id, width, { dungeon: true }) : makeFieldClimbables(map.id, width, layoutStyle),
  ...
  function makeExpandedTrainingMap(config) {
    ...
    const platforms = makeFieldPlatforms(8400, layoutStyle);
    return {
      id: config.id,
      name: config.name,
      ...
      platforms,
      climbables: makeFieldClimbables(config.id, 8400, layoutStyle),
  ...
  const MAPS = Object.freeze([
    { id: 'starfallCrossing', name: 'Starfall Crossing', levelRange: [1, 99], safeZone: true, palette: ['#f7d28a', '#7ec8d8', '#f8f0dc'], purpose: 'Starter town hub, shops, quest handoffs, storage, and upgrade artisan.', enemies: [], platforms: [[0, 520, 3800, 80], [420, 430, 260, 24], [980, 385, 300, 24], [1540, 430, 270, 24]], climbables: [], spawnPoints: [], stations: [{ id: 'storage', name: 'Storage Keeper', x: 420 }, { id: 'shop', name: 'Starter Outfitter', x: 760 }, { id: 'slots', name: 'Slot Broker', x: 1090 }, { id: 'upgrade', name: 'Upgrade Artisan', x: 1460 }, { id: 'class', name: 'Class Supplier', x: 1840 }], questNpcs: [{ id: 'crossing_class_master', name: 'Class Master', x: 2080, platformIndex: 0, questIds: ['trial_ready'], color: '#5e7d9f', accent: '#ffd166' }] },
    makeTownHubMap({
      id: 'rustcoilOutpost',
  ...
  function attachEquipmentItemAssets(item) {
    const visual = EQUIPMENT_VISUALS[item.visualId || item.id] || null;
    const assetId = item.assetId || item.id;
    return Object.freeze(Object.assign({}, item, {
      asset: ITEM_ASSETS[assetId] || ITEM_ASSETS[item.id] || ITEM_ASSETS[item.visualId] || '',
  ...
  const DROP_ECONOMY = Object.freeze({
    ...
    lootWeights: Object.freeze({
      ...
      upgradeCatalyst: 8,
      wardingScroll: 1,
      eliteWardingScroll: 3,
      refinementCore: 1,
      eliteRefinementCore: 2,
      equipmentSlotCoupon: 1,
      eliteEquipmentSlotCoupon: 3,
      mimicEquipmentSlotCoupon: 5,
      usableSlotCoupon: 1,
      eliteUsableSlotCoupon: 2,
      mimicUsableSlotCoupon: 4,
      etcSlotCoupon: 1,
      eliteEtcSlotCoupon: 2,
      mimicEtcSlotCoupon: 4
    })
  });
  ...
  const CONSUMABLE_ITEMS = Object.freeze([
    Object.freeze({ id: 'minor_health_potion', name: 'Minor Health Potion', icon: 'HP', effect: 'Restore 35% max HP.', hpPercent: 0.35 }),
    Object.freeze({ id: 'minor_resource_tonic', name: 'Minor MP Tonic', icon: 'MP', effect: 'Restore 45% MP.', resourcePercent: 0.45 }),
    ...
    Object.freeze({ id: 'camp_ration', name: 'Camp Ration', icon: 'RAT', effect: 'Restore 22% max HP and 22% MP.', hpPercent: 0.22, resourcePercent: 0.22 }),
  ...
  const PARTY_AI_LOADOUTS = Object.freeze({
    fighter: partyAiLoadout({ weapon: 'iron_sword', chest: 'party_plate', boots: 'traveler_boots' }, [
      ...
      { skillId: 'fighter_heavy_strike', minCooldown: 0.72, priority: 1 }
    ]),
    guardian: partyAiLoadout({ weapon: 'iron_sword', chest: 'party_plate', boots: 'traveler_boots', offhand: 'guardian_tower_shield' }, [
      ...
      { skillId: 'guardian_shield_bash', minCooldown: 0.74, priority: 1 }
    ]),
    berserker: partyAiLoadout({ weapon: 'iron_axe', chest: 'party_plate', boots: 'traveler_boots', offhand: 'berserker_war_grip' }, [
      ...
      { skillId: 'berserker_blood_cleave', minCooldown: 0.82, priority: 1 }
    ]),
    duelist: partyAiLoadout({ weapon: 'iron_sword', chest: 'party_plate', boots: 'traveler_boots' }, [
      ...
      { skillId: 'duelist_quick_cut', minCooldown: 0.66, priority: 1 }
    ]),
    mage: partyAiLoadout({ weapon: 'apprentice_staff', chest: 'party_robes', boots: 'traveler_boots' }, [
      ...
      { skillId: 'mage_magic_bolt', minCooldown: 0.74, priority: 1 }
    ]),
    ...
    stormMage: partyAiLoadout({ weapon: 'apprentice_staff', chest: 'party_robes', boots: 'traveler_boots', offhand: 'rune_etched_focus' }, [
      ...
      { skillId: 'storm_mage_chain_bolt', minCooldown: 0.9, priority: 1 }
    ]),
    archer: partyAiLoadout({ weapon: 'oak_longbow', chest: 'party_leathers', boots: 'traveler_boots' }, [
      ...
      { skillId: 'archer_quick_shot', minCooldown: 0.68, priority: 1 }
    ]),
    sniper: partyAiLoadout({ weapon: 'oak_longbow', chest: 'party_leathers', boots: 'traveler_boots', offhand: 'deadeye_scope' }, [
      ...
      { skillId: 'sniper_aimed_shot', minCooldown: 0.9, priority: 1 }
    ]),
    trapper: partyAiLoadout({ weapon: 'oak_longbow', chest: 'party_leathers', boots: 'traveler_boots', offhand: 'trap_kit' }, [
      ...
      { skillId: 'trapper_snare_trap', minCooldown: 0.82, priority: 1 }
    ]),
    beastArcher: partyAiLoadout({ weapon: 'oak_longbow', chest: 'party_leathers', boots: 'traveler_boots', offhand: 'trap_kit' }, [
      ...
      { skillId: 'beast_archer_companion_strike', minCooldown: 0.82, priority: 1 }
    ])
  });
